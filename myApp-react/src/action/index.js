...
import * as http from "../fetch/index"
 ...
 * 
  */
export const fetchQueryData = ({ funcName, params, stateName }) => dispatch => {
    stateName = !stateName && (stateName == funcName);
    dispatch(requestData(stateName));
    return http[funcName](params).then(res => dispatch(receiveData(res, stateName)))
}
 ...
 * 
 * */
export const fetchAddData = ({ funcName, params, stateName }) => dispatch => {
    stateName = !stateName && (stateName == funcName);
    dispatch(requestData(stateName));
...
export const fetchEditData = ({ funcName, params, stateName }) => dispatch => {
    stateName = !stateName && (stateName == funcName);
    dispatch(requestData(stateName));
    return http[funcName](params).then(res => {
        if (res.success) {
